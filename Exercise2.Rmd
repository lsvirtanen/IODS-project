...
gendergroups <- NA
gendergroups[learning2014$gender == "F"] <- 1
gendergroups[learning2014$gender == "M"] <- 2
pairs(learning2014[-1], col = c("red", "blue")[gendergroups])
...
# adding surf as explanatory variable
